<script type="text/x-red" data-template-name="outputCollect">
    <div class="form-row">
        <label for="node-input-name"><i class="fa fa-tag"></i> <span data-i18n="outputCollect.label.name"></span></label>
        <input type="text" id="node-input-name" data-i18n="[placeholder]outputCollect.label.placeholder">
    </div>
    <div class="form-row" style="margin-bottom:0;">
        <label><i class="fa fa-list"></i> <span data-i18n="outputCollect.label.rules"></span></label>
    </div>
    ...
    <div class="form-row">
        <a href="#" class="editor-button editor-button-small" id="node-input-add-in-rule" style="margin-top: 4px;"><i class="fa fa-plus"></i> <span data-i18n="outputCollect.label.addbutton"></span></a>
    </div>
    <div class="form-row">
        <label for="node-input-outkey"><i class="fa fa-sign-out"></i> <span data-i18n="outputCollect.label.outkey"></span></label>
        msg.<input type="text" id="node-input-outkey" style="width:208px;">
    </div>
</script>

<script type="text/x-red" data-help-name="outputCollect">
</script>

<script type="text/javascript">
    RED.nodes.registerType('outputCollect', {
        color: "#E2D96E",
        ...
        icon: "light.png",
        label: function() {
            return this.name|| this._("outputCollect.label.palette");
        },
