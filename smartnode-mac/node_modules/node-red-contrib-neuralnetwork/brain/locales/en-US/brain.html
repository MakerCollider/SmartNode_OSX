...
<script type="text/x-red" data-help-name="brain">
<h3 id="brain node"><a name="brain node" href="#brain node"></a>Robot node</h3>
...
For example: <a href="https://github.com/MakerCollider/node-red-contrib-neuralnetwork" target="_blank">node-red-contrib-neuralnetwork</a>
</script>
